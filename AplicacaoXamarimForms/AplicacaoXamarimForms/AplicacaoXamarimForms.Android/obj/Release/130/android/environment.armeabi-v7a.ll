...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"b51a3a41-5a71-4fc9-8e6b-7ab36d3874ea\00", align 1
...
@__ApplicationConfig_android_package_name.0 = internal constant [42 x i8] c"br.com.pedrohendp.tradutortelefonecelular\00", align 1
...
@application_config = local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 33555331, ; android_runtime_jnienv_class_token
	i32 100674001, ; jnienv_initialize_method_token
	i32 100674000, ; jnienv_registerjninatives_method_token
	...
	i8* getelementptr inbounds ([42 x i8], [42 x i8]* @__ApplicationConfig_android_package_name.0, i32 0, i32 0); android_package_name
}, align 4
